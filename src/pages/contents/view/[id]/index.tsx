...
import { EditorReviewListPage } from 'pages/editor-reviews';
import { SubscriberContentListPage } from 'pages/subscriber-contents';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Explanation" text={data?.explanation} />
