...
import { getEditorReviewById } from 'apiSdk/editor-reviews';
import { EditorReviewInterface } from 'interfaces/editor-review';

function EditorReviewViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('editor_review', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/editor-reviews/edit/${id}`} passHref legacyBehavior>
                    <Button
